...
<body>
  <nav class="white" role="navigation">
    <div class="nav-wrapper container">
      ...
      <a id="logo-container" href="#" class="brand-logo center"><div><img src="icons/brandlabel2.png" style="width: 100px; height: 100px; "></div></a>
...
<div class="card small">
        ...
        <div class="card-content">
          <span class="card-title activator grey-text text-darken-4">Event Name <i class="mdi-navigation-more-vert right"></i></span>
...
<th>
  ...
  <div class="container">
    ...
    <div id="modal1" class="modal" style="margin-left: 60%; width:35%;">
