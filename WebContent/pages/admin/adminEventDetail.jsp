...
<table>
    <tr>
        <td style="width: 20%; vertical-align: top;">
            <jsp:include
                    page="../user/usercabinetpanelleft.jsp"/>
        </td>
                            ...
                            <div style="visibility: hidden" id="footer">
                                <a class="update-event-avatar" href="updateUserAvatar.do"
                                   data-url="updateEventAvatar.do" id="updateAvatar">
                                    ...
                                    Set on avatar</a>
                                <a class="delete-event-photo" data-value="" href="#_" id="deletePhoto"
                                   style="float: right">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 8%;"><label for="minuteTo">
                                                    minute:</label> <input type="number" name="minuteTo" min="00"
                                                                           max="59" id="minuteTo" value="${minuteTo}">
                                                </td>
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
											<textarea id="description" name="description" rows="10"
                                                      cols="45" maxlength="400"
                                                      class="materialize-textarea">${requestScope.event.description}</textarea>
                                                        ...
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                ...
                                                                <td style="width: 25%;"><input type="number"
                                                                                               ...
                                                                                               min="0"
                                                                                               id="age_limit_to">
                                                                    <label for="age_limit_to">editEvent.age_to</label>
                                                                </td>
...
<div id="confirmDeleteModal" class="modal" style="width: 25%">
    ...
    <div class="modal-footer">
        <a href="#_" id="modalDeletePhotoAnchor" data-value=""
           class=" modal-action modal-close waves-effect waves-green btn-flat">Yes, delete it</a>
    </div>
</div>
