...
<head>
	...
	<ct:showLocale basename="locale.home.messages"  from = "userCabinet.do" />
...
<table>
    <tr style="width: 100%;">
        ...
        <td style="width: 21%; vertical-align: top;">
            <jsp:include
                    page="usercabinetpanelleft.jsp"/>
        </td>


        <td style="width: 59%; vertical-align: top;"><c:choose>
            ...
            <c:when test="${centralContent == 'addEvent' }">
        ...
        <td style="width: 20%; vertical-align: top;"><c:choose>
            ...
            <c:when test="${centralContent == 'addEvent' }">
                <jsp:include page="recommendedevents.jsp"/>
            </c:when>
            <c:when test="${centralContent == 'fileupload'}">
