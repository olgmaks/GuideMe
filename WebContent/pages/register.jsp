			...
			function() {
				...
				$('#confirm').change(
						function() {
							...
							$.ajax({
								type : "post",
								url : 'confirmValidator.do?password=' + pass
										+ '&confirm=' + conf,
...
<body>
	...
	<form action="submitRegister.do" method="post" id="registerform"
		name="registerform">
		loginpage.firstName: <input type="text" id="firstName"
			name="firstName" /> <span id="firstNameMessage"></span> <br>
		loginpage.lastName: <input type="text" id="lastName" name="lastName" />
		<span id="lastNameMessage"></span> <br> loginpage.email: <input
			type="text" id="email" name="email" /> <span id="emailMessage"></span>
		<br> loginpage.password: <input type="password" id="password"
			name="password" /> <span id="passwordMessage"></span> <br>

		loginpage.confirm: <input type="password" id="confirm" name="confirm" />
		<span id="confirmMessage"></span> <br> loginpage.sex: <select
			id="sex" name="sex">
		...
		</select> <span id="sexMessage"></span> <br> loginpage.cellNumber: <input
			type="text" id="cellNumber" name="cellNumber" /> <span
			id="cellNumberMessage"></span> <br> loginpage.adress:
		...
		<c:forEach items="${requestScope.languageList}" var="lang">
			...
			<br>
        loginpage.address: <input type="text"
				id="addressByLang_${lang.id}" name="addressByLang_${lang.id}" />
		...
		<br> <br> <input type="hidden" id="cityId" name="cityId" />
		<span id="cityIdMessage"></span> <br> <br>
