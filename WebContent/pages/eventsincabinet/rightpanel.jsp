...
<div class="collection" style="margin-top: 5%;">
	<a href="eventsincabinet.do"
		...
		id="test">All</a> <a href="moderatoEvents.do" class="collection-item  <c:if test="${centralContent == 'moderatorevent' }">active</c:if>">Own</a>
	<a href="#" class="collection-item">Resident</a>
</div>