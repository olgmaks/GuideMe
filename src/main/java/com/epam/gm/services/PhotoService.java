...
public class PhotoService {
    ...
    public void deletePhotoByPath(String path) throws SQLException, IllegalAccessException {
        //todo still need delete from folder in system explorer c:\\ ....
        photoDao.deleteByField("path", path);
    }

    public Photo getPhotoByPath(String path) throws SQLException {

        Photo result = null;

        List<Photo> resultList =  photoDao.getByField("path", path);
