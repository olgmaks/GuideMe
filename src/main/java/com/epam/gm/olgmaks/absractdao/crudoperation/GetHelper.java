...
//	private T t;
	...
	public PreparedStatement getByFieldName(String fieldName, Object fieldValue)throws SQLException {
	...
	public PreparedStatement customQuery(String sqlWithRestrictions) throws SQLException {
		String baseSelect = IDao.SELECT;
		String sql = String.format(baseSelect, (tableName + " " + sqlWithRestrictions));
