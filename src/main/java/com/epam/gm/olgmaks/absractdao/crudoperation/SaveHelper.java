...
public class SaveHelper<T> extends AbstractHelper<T> {
    ...
    public PreparedStatement prepareSave(Connection connection, T t) throws IllegalArgumentException,IllegalAccessException {
...
//            System.out.println("exception duringinserting " +sql);
    ...
    public PreparedStatement prepareSaveWithId (Connection connection, T t) throws SQLException, IllegalArgumentException, IllegalAccessException {
	init(t);

        sql = String.format(AbstractDao.INSERT, tableName, fieldNameSequence,unknownValues);
        preparedStatement = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);
        Iterator<Object> fieldValueIterator = fieldValues.iterator();
        int columnIndex = 1;
        while (fieldValueIterator.hasNext()) {
            preparedStatement.setObject(columnIndex++,fieldValueIterator.next());
        }
