...
public class User implements Comparable<User> {
	...
	public String getNameCityPoints() {
		return new StringBuilder(getNameAndCity()).append(", rate: ")
	...
	public String toString() {
		return "User{" + "Id=" + Id + ", lastName='" + lastName + '\''
				...
				+ '\'' + ", sex='" + sex + '\'' + ", userTypeId=" + userTypeId
				+ ", userType=" + userType + ", langId=" + langId + ", lang="
				+ lang + ", cellNumber='" + cellNumber + '\''
				+ ", facebookId='" + facebookId + '\'' + ", vkId='" + vkId
				+ '\'' + ", isActive=" + isActive + ", addressId=" + addressId
				+ ", address=" + address + ", password='" + password + '\''
				+ ", avatarId=" + avatarId + ", avatar=" + avatar + '}';
	}
