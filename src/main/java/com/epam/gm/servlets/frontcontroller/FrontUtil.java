	...
	public static Map<String, HttpRequestHandler> buildHandlers(String propsFile) throws Exception {
		...
		try {
			...
			while (enKeys.hasMoreElements()) {
				...
				if (checkInterface(handClazz, "com.epam.gm.servlets.frontcontroller.HttpRequestHandler")) {
					HttpRequestHandler handler = (HttpRequestHandler) handClazz.newInstance();
					handlers.put(key, handler);
				} else {
					throw new Exception("com.epam.gm.servlets.frontcontroller.HttpRequestHandler interface ");
				}
			}
